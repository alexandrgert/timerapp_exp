...
Документация: [архитектура](docs/architecture-cross-platform.md) · [схема данных](docs/data-schema.md) · [WebDAV (техн.)](docs/webdav-sync.md) · [системные требования](docs/system-requirements.md) · [релиз 0.11.0](docs/release-notes-v0.11.0.md)
...
**Текущая версия в ветке:** **0.11.0** — [release notes](docs/release-notes-v0.11.0.md)
...
| Linux amd64 (Flatpak, ID `com.timerapp.exp`) | `timerapp-exp-0.11.0-x86_64.flatpak` |
| Linux amd64 (Snap `timerapp-exp`, strict) | `timerapp-exp-0.11.0-amd64.snap` |
| Linux amd64 (Gentoo ebuild + overlay, **experimental**) | `timerapp-exp-0.11.0.ebuild`, `timerapp-exp-0.11.0-gentoo-overlay.tar.xz` |
| Linux amd64 (PiSi, **experimental**) | `timerapp-exp-0.11.0-x86_64.pisi` |
| Linux amd64 (PET, **experimental**) | `timerapp-exp-0.11.0-amd64.pet` |
| Linux amd64 (PUP, **experimental**) | `timerapp-exp-0.11.0-amd64.pup` |
| Linux amd64 (Slax LZM, **experimental**) | `timerapp-exp-0.11.0-amd64.lzm` |
| Windows x64 | `timerapp-exp-0.11.0-win64.exe` |
| macOS arm64 | `timerapp-exp-0.11.0-macos-arm64.zip` |
| Android 10+ | `timerapp-exp-0.11.0-android.apk` |

Linux — установка `.deb` (локальная сборка или релиз):

```bash
sudo dpkg -i dist/timerapp-exp-0.11.0-amd64.deb
sudo apt-get install -f
timerapp-exp
```

AppImage: `chmod +x timerapp-exp-0.11.0-x86_64.AppImage && ./timerapp-exp-0.11.0-x86_64.AppImage`
