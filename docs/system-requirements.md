...
Текущая версия в ветке **timerapp_exp**: **0.11.1** (см. [`pyproject.toml`](../pyproject.toml)).  
...
### Функциональность (0.11.1 Experiment — desktop)
...
**Текущая версия Experiment (ветка):** **0.11.1** — все платформы из CI / [Releases](https://github.com/alexandrgert/timerapp_exp/releases).
...
- [release-notes-v0.11.1.md](release-notes-v0.11.1.md) — что нового в Experiment 0.11.1
