...
**При аварийном завершении** (завершение процесса системой, `SIGTERM`, прерывание из терминала)
срабатывает та же процедура: сохранение и резервная копия, насколько это возможно.
