...
def test_focus_session_title_contains_start_datetime() -> None:
    from timerapp_ag.domain.task_ops import focus_session_title
...
def test_sanitize_closes_unlinked_open_focus_session(
    ...
    from timerapp_ag.domain.task_ops import create_focus_session_task

    orphan = create_focus_session_task(controller.state, 5)
